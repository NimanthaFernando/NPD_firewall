...
from tkinter import messagebox, ttk, filedialog  # Import filedialog for saving files
from pyroute2 import IPRoute
import threading
from scapy.all import sniff, IP, TCP, UDP, ICMP  # Import Scapy for packet inspection
from datetime import datetime  # To add dates to logs
...
class SimpleFirewall:
    def __init__(self, master):
        ...
        self.log_text = tk.Text(self.log_frame, height=40, width=120)  # Wider log area
